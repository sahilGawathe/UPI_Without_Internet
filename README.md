...
## My Notes
Forked and ran this project locally to understand mesh-routed offline payments,
hybrid RSA+AES-GCM encryption, and idempotent settlement design.
Built and tested with JDK 21 + Spring Boot 3.3 on Windows.
